...
def set_decoding_to_dfa_constrained(model,
    ...
    assert isinstance(model, GenerationMixin), "Model must be an instance of `transformers.generation.utils.GenerationMixin` to be applied the dfa-constrained `beam_search` method."
